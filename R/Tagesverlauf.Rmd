...
new_BuPla_Zoll <- new_BuPla_Zoll |>
  ...
  select(-month, -day, -hour, -minute, -Time.y)
...
Bupla <-
  ...
  theme(legend.position=c(0.50,0.09), legend.direction = "horizontal", legend.background=element_rect(fill="white", color="black"))
