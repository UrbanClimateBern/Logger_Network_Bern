...
```{r read, include = F}
data<-read_csv("../data/Analysis 2023/Rawdata_T_2023_MJJAS.csv")
...
meta <- read_csv2("../data/metadata_network_2023.csv") |>
  select(Log_NR, STANDORT_NEU, NORD_CHTOPO, OST_CHTOPO) |>
...
```{r export, includ = F}
write_csv(Summary, ("../data/Analysis 2023/Summary_T_2023_MJJAS.csv"))
```
