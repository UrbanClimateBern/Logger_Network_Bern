...
setwd("D:/PhD_Moritz/Stadt Bern_Austausch/Berechnungen/Factsheets/2022") # Summary


list.files()

data<-read.csv("TNSD_22.csv", header=T, sep=";") # TN und SD aus summary

##Aufarbeitung der Hitergrunddaten

setwd("U:/GIS-data/AVR-Daten/Daten_mutiert/Grundfl?chen/Raster_Daten") # git
...
TN_22<-
  ...
  labs(title="Berner Tropenn?chte 2022")+
